...
/* DDRFirmwareContentCertPK */
#define DDR_FW_CONTENT_CERT_PK_OID	"1.3.6.1.4.1.4128.2100.1401"

/*
 * DDR Firmware Content Certificate
 */

/* DDR Firmware Hash */
#define DDR_FW_HASH_OID	"1.3.6.1.4.1.4128.2100.1402"
