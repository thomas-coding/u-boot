...
toc_entry_t toc_entries[] = {
	...
	{
		.name = "BL2 DDR Firmware",
		.uuid = UUID_BL2_DDR_FIRMWARE,
		.cmdline_name = "ddr-fw"
	},
	/* Dynamic Configs */
	{
	...
	{
		.name = "BL2 DDR Firmware key certificate",
	...
	{
		.name = "BL2 DDR Firmware content certificate",
		.uuid = UUID_DDR_FW_CONTENT_CERT,
		.cmdline_name = "ddr-fw-cert"
	},
	{
		.name = NULL,
		.uuid = { {0} },
